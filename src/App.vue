<template>
  ...
  <div class="app">
    ...
    <div class="img">
    <img alt="Protein" src="./assets/20210810_atliving_protein_main-760x507.jpg" width="500">
</div>
      ...
      <div class="flexitem2">
        <img src="./assets/新規メモ.jpeg" alt="バナー03です"><router-link to="/login">ログイン</router-link>
      </div>
...
<button @click="sendFlavors">search</button>
  ...
  <div>
    <ul>
      <li v-for="(testes, index) in testesList" :key="index">
        {{ testes.name }} - {{ testes.price }} - {{ testes.img }}
      </li>
    </ul>
  </div>
</div>
